...
export const unassign = command("unassign", {
  short: "Unassign a startup script",
  long: `
    Unassign a startup script from a machine.
  `,
  commands: subCommands,
  args: args().tuple([
    z.string().describe("The ID of the startup script to unassign"),
  ]).optional(),
  flags: flags({
    fields,
  }).merge(flags({
    "machine-id": flag({
      short: "The ID of the machine to unassign the startup script from",
    }).string(),
  })),
